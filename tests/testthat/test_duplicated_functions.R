...
test_that("view_duplicated requires a data frame", {
  ...
  expect_error(view_duplicated(list(a = 1:10, b = 1:10)))
  expect_equal(view_duplicated(tibble::as.tibble(dups)), empty_df)
})

test_that("view_duplicated only accepts columns within dataframe", {
...
test_that("removes_duplicated removes duplicates", {
  ...
  # converting tests to data.frame to avoid issue of comparing numeric to int issue of tibble
...
# 
# test_that("remove_duplicated requires a data frame", {
#   expect_error(remove_duplicated())
#   expect_error(remove_duplicated(1:10))
#   expect_error(remove_duplicated(list(a = 1:10, b = 1:10)))
#   expect_error(remove_duplicated(dups, q, v))
#   # expect_equal(view_duplicated(tibble::as.tibble(dups)), empty_df)
# })
# 
# 
